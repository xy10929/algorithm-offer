...
//    return Math.min(data.uncover + 1, Math.min(data.cover, data.in));
//}
//
//public class info{
//    public int uncover;
...
//    public int in;
//    
//    public info(int uncover, int cover, int in){
...
//    if(n == null){
//        return new info(1001, 0, 1001);
//    }
//    info left = process(n.left);
//    info right = process(n.right);
//    
//    int uncover = left.cover + right.cover;
//    
//    int cover = Math.min(left.in + right.in, Math.min(left.in + right.cover, left.cover + right.in));
//    
//    int in = Math.min(left.uncover, Math.min(left.cover, left.in)) +
//             Math.min(right.uncover, Math.min(right.cover, right.in)) + 1;
//    
//    return new info(uncover, cover, in);
//}

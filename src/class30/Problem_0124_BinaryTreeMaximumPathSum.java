...
//	public class info {
//		public int max;
//		public int maxfromhead;
//
//		public info(int max, int maxfromhead) {
//			this.max = max;
...
//		int maxfromhead = node.val;
//		if (leftinfo != null) {
//			maxfromhead = Math.max(maxfromhead, leftinfo.maxfromhead + node.val);
//		}
//		if (rightinfo != null) {
//			maxfromhead = Math.max(maxfromhead, rightinfo.maxfromhead + node.val);
//		}
//		int max = maxfromhead;
//		if (leftinfo != null) {
...
//			max = Math.max(max, node.val + leftinfo.maxfromhead + rightinfo.maxfromhead);
//		}

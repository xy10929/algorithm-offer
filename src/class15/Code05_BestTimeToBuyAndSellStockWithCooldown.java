...
//			return 0;
//		}
//		int[] afterlastbuy = new int[n];
//		int[] afterlastsell = new int[n];
//		afterlastbuy[1] = Math.max(-prices[0], -prices[1]);
//		afterlastsell[1] = Math.max(prices[1] - prices[0], 0);
//		for (int i = 2; i < n; i++) {
//			afterlastbuy[i] = Math.max(afterlastbuy[i - 1], afterlastsell[i - 2] - prices[i]);
//			afterlastsell[i] = Math.max(afterlastsell[i - 1], afterlastbuy[i - 1] + prices[i]);
//		}
//		return afterlastsell[n - 1];
//	}

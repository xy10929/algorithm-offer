...
//			sum += n;
//		}
//		return sum < target || ((target & 1) ^ (sum & 1)) != 0 ? 0 : sub(arr, (target + sum) >> 1);
//	}
//    
//    public int sub2(int[] arr, int s){
//        if(s < 0){
//            return 0;
//        }
//        int n = arr.length;
...
//    }
//    
//    public int sub(int[] arr, int s){
//        return process(arr, 0, s);
//    }
//    
//    public int process(int[] arr, int index, int s){
//        if(index == arr.length){
//            return s == 0 ? 1 : 0;
//        }
//        int p1 = process(arr, index + 1, s);
//        int p2 = 0;
//        if(s - arr[index] >= 0){
//            p2 = process(arr, index + 1, s - arr[index]);
//        }
//        return p1 + p2;
//    }
//}

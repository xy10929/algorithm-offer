...
//	}
//
//	public boolean process(char[] s, char[] p, int si, int pi, int[][] dp) {
//		if (dp[si][pi] != 0) {
//			return dp[si][pi] == 1;
//		}
//		boolean ans = false;
...
//		} else {
//			if (pi + 1 == p.length || p[pi + 1] != '*') {
//				ans = si < s.length && (s[si] == p[pi] || p[pi] == '.') && process(s, p, si + 1, pi + 1, dp);
//			} else {
//				while (si < s.length && (p[pi] == s[si] || p[pi] == '.')) {
...
//				}
//
//				ans = ans | process(s, p, si, pi + 2, dp);
//			}
//		}
//		dp[si][pi] = ans ? 1 : -1;
//		return ans;
...
//			} else {
//				if (si == s.length) {
//					ans = process(s, p, si, pi + 2, dp);
//				} else {
//					if (s[si] != p[pi] && p[pi] != '.') {
//						ans = process(s, p, si, pi + 2, dp);
//					} else {
//						ans = process(s, p, si, pi + 2, dp) || process(s, p, si + 1, pi, dp);
//					}
//				}
//			}
//		}
